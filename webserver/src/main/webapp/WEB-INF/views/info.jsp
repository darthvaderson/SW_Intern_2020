    ...
    <div id="wrapper">
        ...
        <div id="abc">
            ...
            <div class="content-2">
                ...
                <ul class="info">
                    <div class="info_1">
                        <li id="ip1">IP 주소 : 192.172.01.3<%= request.getAttribute("ip1")%></li>
                        <li id="cpu1">CPU 사용량 : 15<%= request.getAttribute("cpu1")%> %</li>
                        <li id="memory1">메모리 사용량 : 33<%= request.getAttribute("memory1")%> %</li>
                        <li id="number1">데이터 처리량 : 273<%= request.getAttribute("number1")%></li>
                    </div>
                </ul>
